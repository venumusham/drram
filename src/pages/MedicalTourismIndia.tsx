...
const COUNTRY_COMPARISONS = [
  { country: 'India (Kondapur, Hyderabad)', currency: 'USD', rhinoplasty: '$850 - $2,200', liposuction: '$720 - $2,400', gynecomastia: '$600 - $1,800', tummyTuck: '$1,700 - $3,400', facelift: '$1,450 - $3,600' },
  { country: 'UAE (Dubai)', currency: 'USD', rhinoplasty: '$5,000 - $9,000', liposuction: '$3,500 - $8,000', gynecomastia: '$3,500 - $6,000', tummyTuck: '$8,000 - $12,000', facelift: '$8,000 - $14,000' },
  { country: 'UK', currency: 'USD', rhinoplasty: '$5,500 - $10,000', liposuction: '$5,000 - $10,000', gynecomastia: '$4,500 - $8,000', tummyTuck: '$8,000 - $13,000', facelift: '$9,000 - $15,000' },
  { country: 'USA', currency: 'USD', rhinoplasty: '$8,000 - $15,000', liposuction: '$6,000 - $12,000', gynecomastia: '$4,000 - $8,500', tummyTuck: '$10,000 - $16,000', facelift: '$11,000 - $20,000' },
];

const PROCEDURES = [
  { name: 'Rhinoplasty', priceUSD: '$850 - $2,200', priceINR: '₹70,000 - ₹1,80,000', stay: '10-14 days', link: '/rhinoplasty-hyderabad' },
  { name: 'Gynecomastia Surgery', priceUSD: '$600 - $1,800', priceINR: '₹50,000 - ₹1,50,000', stay: '5-7 days', link: '/gynecomastia' },
  { name: 'Liposuction', priceUSD: '$720 - $2,400', priceINR: '₹60,000 - ₹2,00,000', stay: '7-10 days', link: '/liposuction-hyderabad' },
  { name: 'Facelift', priceUSD: '$1,450 - $3,600', priceINR: '₹1,20,000 - ₹3,00,000', stay: '14-21 days', link: '/facelift-hyderabad' },
  { name: 'Breast Augmentation', priceUSD: '$1,450 - $3,000', priceINR: '₹1,20,000 - ₹2,50,000', stay: '7-10 days', link: '/breast-augmentation-hyderabad' },
  { name: 'Tummy Tuck', priceUSD: '$1,700 - $3,400', priceINR: '₹1,40,000 - ₹2,80,000', stay: '14-21 days', link: '/tummy-tuck-hyderabad' },
];

const ITINERARY = [
  { day: 'Day 1', activity: 'Arrival in Hyderabad. Airport pickup arranged. Check-in at chosen accommodation. Rest day.' },
  { day: 'Day 2', activity: 'In-person consultation with Dr. Ram Prabhu (1-2 hours). Pre-op investigations: blood work, ECG, ultrasound if needed. Pre-op photographs.' },
  { day: 'Day 3', activity: 'Surgery day. Same-day discharge for minor procedures; overnight observation for major ones.' },
  { day: 'Day 4-5', activity: 'Post-op recovery at accommodation. WhatsApp follow-up + one in-person follow-up at the clinic.' },
  { day: 'Day 6-7', activity: 'Suture removal (if applicable). Final follow-up consultation. Discharge summary with home-country care plan.' },
  { day: 'Day 8+', activity: 'Departure for home country (varies by procedure). Light tourism if comfortable: Charminar, Golconda Fort, Ramoji Film City.' },
  { day: 'Post-arrival', activity: '90 days of WhatsApp follow-up support. Dr. Ram Prabhu personally reviews all post-op concerns.' },
];
...
const MedicalTourismIndia: React.FC = () => {
  ...
  const serviceSchema = {
    ...
    areaServed: ['United States', 'United Kingdom', 'United Arab Emirates', 'Qatar', 'Australia', 'Canada', 'Singapore', 'Saudi Arabia', 'Oman', 'Bahrain', 'Kuwait', 'New Zealand'],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Medical Tourism India', item: url },
    ],
  };
  ...
  return (
    <>
      <SEO
        ...
        description="Medical tourism plastic surgery for NRI & international patients in Hyderabad. Save 60-75% vs USA/UK, 40-60% vs UAE. DNB Plastic Surgeon, FDA implants, concierge service. WhatsApp 9949808628."
        keywords={[
      ...
      <div className="relative min-h-screen bg-white">
        ...
        <section className="pt-8 pb-10 px-4 bg-gradient-to-br from-primary-900 to-primary-800 text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">
              Plastic Surgery in India — Save 60-75% vs USA / UK with Dr. Ram Prabhu
            </h1>
            <p className="text-primary-100 text-base md:text-lg mb-5 max-w-2xl">
              Premium plastic surgery for NRI and international patients in Hyderabad. DNB Super Speciality Plastic Surgeon. FDA-approved implants. Full concierge service: airport pickup, accommodation, translator, follow-up.
            </p>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="bg-primary-700 px-3 py-1 rounded-full text-xs font-semibold">★ DNB Plastic Surgery</span>
              <span className="bg-primary-700 px-3 py-1 rounded-full text-xs font-semibold">FDA-Approved Implants</span>
              <span className="bg-primary-700 px-3 py-1 rounded-full text-xs font-semibold">Concierge Service</span>
              <span className="bg-primary-700 px-3 py-1 rounded-full text-xs font-semibold">90-Day Remote Follow-up</span>
              <span className="bg-primary-700 px-3 py-1 rounded-full text-xs font-semibold">English / Hindi / Telugu</span>
            </div>
            <div className="bg-yellow-300 text-primary-900 inline-block px-4 py-2 rounded-lg font-bold text-lg mb-6">
              Free Video Consultation — WhatsApp 9949808628
            </div>
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 mb-4">
              Over 2 million international patients travel to India annually for medical care, with plastic surgery being one of the fastest-growing specialties. The reasons are simple: <strong>same quality at 25-40% the cost</strong>, internationally-trained surgeons, modern hospital infrastructure, English-speaking staff, and short waiting times.
            </p>
            <p className="text-gray-700 mb-4">
              For NRI Indians, the calculation is even more favourable — combining a homeland visit with high-quality medical care, often paid for from accumulated NRE/NRO accounts. Hyderabad specifically attracts patients from the UAE (3-hour flight), UK, USA, Australia, and across Southeast Asia.
            </p>
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-primary-50 p-5 rounded-lg">
                <h3 className="font-bold text-primary-800 mb-2">💰 60-75% Cost Savings</h3>
                <p className="text-sm text-gray-700">Even with airfare and accommodation, total cost is far below US/UK prices.</p>
              </div>
              <div className="bg-primary-50 p-5 rounded-lg">
                <h3 className="font-bold text-primary-800 mb-2">🏥 International Standards</h3>
                <p className="text-sm text-gray-700">DNB-qualified surgeon, NABH hospitals, FDA-approved implants, modern equipment.</p>
              </div>
              <div className="bg-primary-50 p-5 rounded-lg">
                <h3 className="font-bold text-primary-800 mb-2">⏱️ No Waiting List</h3>
                <p className="text-sm text-gray-700">Surgery scheduled within days, not months. Direct access to senior surgeon.</p>
              </div>
              <div className="bg-primary-50 p-5 rounded-lg">
                <h3 className="font-bold text-primary-800 mb-2">🗣️ English-Speaking Care</h3>
                <p className="text-sm text-gray-700">Surgeon and full clinic staff fluent in English, Hindi, and Telugu.</p>
              </div>
              <div className="bg-primary-50 p-5 rounded-lg">
                <h3 className="font-bold text-primary-800 mb-2">🛬 Easy Connectivity</h3>
                <p className="text-sm text-gray-700">Hyderabad airport with direct flights from UAE, UK, USA, Singapore, Doha.</p>
              </div>
              <div className="bg-primary-50 p-5 rounded-lg">
                <h3 className="font-bold text-primary-800 mb-2">📱 90-Day Remote Care</h3>
                <p className="text-sm text-gray-700">Personal WhatsApp follow-up with Dr. Ram Prabhu after you return home.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-4 bg-primary-50">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-gray-700 mb-6">
              All prices in USD for direct comparison. Indian prices include surgeon fee, anaesthesia, OT, hospital stay, and follow-up.
            </p>
              ...
              <table className="min-w-full text-sm">
                <thead className="bg-primary-700 text-white">
                  <tr>
                    ...
                    <th className="px-3 py-3 text-left font-semibold">Rhinoplasty</th>
                    <th className="px-3 py-3 text-left font-semibold">Liposuction</th>
                    <th className="px-3 py-3 text-left font-semibold">Gynecomastia</th>
                    <th className="px-3 py-3 text-left font-semibold">Tummy Tuck</th>
                    <th className="px-3 py-3 text-left font-semibold">Facelift</th>
                  </tr>
                </thead>
                <tbody>
                  {COUNTRY_COMPARISONS.map((c, i) => (
                    <tr key={c.country} className={i === 0 ? 'bg-yellow-50 font-semibold' : i % 2 === 0 ? 'bg-white' : 'bg-primary-50'}>
            ...
            <p className="text-xs text-gray-500 mt-3">
              Sources: International Medical Travel Journal estimates, Patients Beyond Borders 2024 cost data. Indian prices reflect Dr. Ram Prabhu's transparent fixed packages. 1 USD ≈ ₹83 at time of writing.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 mb-6">
              All-inclusive packages — surgeon, anaesthesia, OT, hospital, follow-up. EMI available for OCI/PIO cardholders.
            </p>
            <div className="grid sm:grid-cols-2 gap-4">
              {PROCEDURES.map((p) => (
                ...
                >
                  <h3 className="text-lg font-bold text-primary-800 mb-2">{p.name}</h3>
                  <div className="text-2xl font-bold text-primary-700 mb-1">{p.priceUSD}</div>
                  <div className="text-sm text-gray-500 mb-2">({p.priceINR})</div>
                  <div className="text-sm text-gray-700"><strong>Recommended stay:</strong> {p.stay}</div>
                  <div className="mt-3 text-primary-600 text-sm font-semibold">View details →</div>
                </Link>
              ))}
            </div>
          </div>
        ...
        <section className="py-12 px-4 bg-primary-50">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-3">
              {ITINERARY.map((s) => (
                <div key={s.day} className="flex gap-4 bg-white border-l-4 border-primary-600 shadow-sm p-4 rounded">
                  <div className="flex-shrink-0 w-28 font-bold text-primary-700">{s.day}</div>
        ...
        <section className="py-12 px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-700 mb-6">
              Complimentary for procedures over ₹1,00,000. Optional fee-based service otherwise.
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white border border-primary-100 rounded-lg p-5">
                <h3 className="font-bold text-primary-800 mb-2">🛬 Travel Support</h3>
              ...
              <div className="bg-white border border-primary-100 rounded-lg p-5">
                <h3 className="font-bold text-primary-800 mb-2">🏨 Accommodation</h3>
                <ul className="text-gray-700 text-sm space-y-1 list-disc pl-4">
              ...
              <div className="bg-white border border-primary-100 rounded-lg p-5">
                <h3 className="font-bold text-primary-800 mb-2">🗣️ Language Support</h3>
                <ul className="text-gray-700 text-sm space-y-1 list-disc pl-4">
              ...
              <div className="bg-white border border-primary-100 rounded-lg p-5">
                <h3 className="font-bold text-primary-800 mb-2">🌆 Tourism (Optional)</h3>
                <ul className="text-gray-700 text-sm space-y-1 list-disc pl-4">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="bg-primary-800 p-5 rounded-lg">
                ...
                <p className="text-primary-100 text-sm">National Board of Examinations, New Delhi (2019). Recognised internationally as equivalent to MCh in India.</p>
              </div>
              <div className="bg-primary-800 p-5 rounded-lg">
                <h3 className="font-bold mb-2">📅 16+ Years Experience</h3>
                <p className="text-primary-100 text-sm">MBBS 2009. 6,000+ procedures across cosmetic and reconstructive surgery.</p>
              </div>
              <div className="bg-primary-800 p-5 rounded-lg">
                <h3 className="font-bold mb-2">🏛️ TSMC Reg #66931</h3>
                <p className="text-primary-100 text-sm">Telangana State Medical Council. NMC registered. IAAPS & APSI member.</p>
              </div>
              <div className="bg-primary-800 p-5 rounded-lg">
                <h3 className="font-bold mb-2">⭐ 140+ Google Reviews</h3>
                <p className="text-primary-100 text-sm">Read verified patient experiences on the Google Business Profile.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="booking" className="py-12 px-4 bg-primary-50">
          <div className="max-w-lg mx-auto bg-white rounded-lg shadow-lg p-6">
            ...
            >
              ...
              <input type="hidden" name="_subject" value="New International Patient Inquiry" />
              <input
                type="text"
                name="name"
              ...
              <select
                ...
                required
              >
                <option value="" disabled>Procedure of Interest *</option>
              ...
              <p className="text-xs text-gray-500 text-center">
                Or WhatsApp <a href={waUrl} target="_blank" rel="noopener noreferrer" className="text-primary-700 font-semibold">+91 9949808628</a> for instant response.
              </p>
            </form>
          </div>
        </section>
        ...
        <section className="py-12 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-4">
              <a href={MAPS_URL} target="_blank" rel="noopener noreferrer" className="bg-yellow-500 text-white px-5 py-2 rounded shadow hover:bg-yellow-600 transition">Get Directions</a>
              <a href={`tel:${PHONE_INTL}`} className="bg-primary-700 text-white px-5 py-2 rounded shadow hover:bg-primary-800 transition">Call +91 9949808628</a>
              <a href={waUrl} target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white px-5 py-2 rounded shadow hover:bg-green-600 transition">WhatsApp</a>
            </div>
          </div>
        </section>
      </div>
