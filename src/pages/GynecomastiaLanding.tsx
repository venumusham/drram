      ...
      <div className="relative min-h-screen bg-gradient-to-br from-primary-50 to-white">
        ...
        <section className="pt-8 pb-6 px-2 bg-primary-900 text-white">
          <div className="max-w-lg mx-auto flex flex-col items-center">
            ...
            <div className="w-full flex gap-2 mb-2 overflow-x-auto pb-1">
              <a href="tel:9949808628" className="min-w-[80px] bg-gradient-to-br from-green-200 via-green-100 to-green-300 rounded-lg shadow p-1 flex flex-col justify-between relative focus:outline-none focus:ring-2 focus:ring-primary-700 min-h-[40px]">
              ...
              <a href="tel:9949808628" className="min-w-[80px] bg-gradient-to-br from-yellow-200 via-yellow-100 to-yellow-300 rounded-lg shadow p-1 flex flex-col justify-between relative focus:outline-none focus:ring-2 focus:ring-primary-700 min-h-[40px]">
        ...
        <section className="py-10 px-4 bg-primary-50">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mt-4">
              <a href="tel:9949808628" className="bg-primary-700 text-white px-6 py-2 rounded shadow hover:bg-primary-800 transition">Call Now</a>
            </div>
          </div>
        </section>
      </div>
